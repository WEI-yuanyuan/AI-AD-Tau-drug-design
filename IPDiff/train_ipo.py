...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_max_iters', type=int, default=None)
    parser.add_argument('--logdir', type=str, default='./logs_diffusion')
    parser.add_argument('--tag', type=str, default='')
    parser.add_argument('--train_report_iter', type=int, default=200)
    parser.add_argument('--reprocess', action='store_true')
    parser.add_argument('--dpo_data', type=str, default='/home/adrianchen/AI-AD-Tau-drug-design/temp/dpo_idx.pkl')
    parser.add_argument('--affinity_path', type=str, default='/home/adrianchen/AI-AD-Tau-drug-design/temp/affinity_info.pkl')
    ...
    if args.train_max_iters is not None:
        config.train.max_iters = args.train_max_iters
    ...
    logger.info(args)
    logger.info(config)
    # TODO: correctly copy config and models
    ...
    def get_dpo_data(subset, split='train', fullset=dataset):
        ...
        dpo_subset = MergedProteinLigandData(subset_1, subset_2, affinity_path=args.affinity_path)
        ...
        with torch.no_grad():
            ...
            for batch in tqdm(val_loader, desc='Validate'):
                ...
                for t in np.linspace(0, model.num_timesteps - 1, 10).astype(int):
                    ...
                    results = model.get_diffusion_loss_org(
                        net_cond=net_cond,
