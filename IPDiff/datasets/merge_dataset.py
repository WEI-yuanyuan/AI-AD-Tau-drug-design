...
class MergedProteinLigandData(Dataset):
    def __init__(self, dataset1, dataset2, affinity_path):
    ...
    def __getitem__(self, idx):
        ...
        affinity1 = self.affinity_info[sample1['ligand_filename'][:-4]]
        affinity2 = self.affinity_info[sample2['ligand_filename'][:-4]]
