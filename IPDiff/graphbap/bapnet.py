...
class BAPNet(nn.Module):
    def __init__(self, ckpt_path=None,
        ...
        ### Original ### self.FusionGraph.append(GATConv(graph_dim * 2, graph_dim * 1, GAT_head, concat=False))
        self.FusionGraph.append(GATConv((graph_dim * 2, graph_dim * 2), graph_dim * 1, GAT_head, concat=False))
